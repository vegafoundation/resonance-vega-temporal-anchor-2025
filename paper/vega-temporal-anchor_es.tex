...
\title{Vega Temporal Anchor: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce Vega Temporal Anchor como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
