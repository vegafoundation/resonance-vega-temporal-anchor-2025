...
\title{Vega Temporal Anchor: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет Vega Temporal Anchor как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
