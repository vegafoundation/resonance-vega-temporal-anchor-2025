...
\title{Vega Temporal Anchor: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Vega Temporal Anchor'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
